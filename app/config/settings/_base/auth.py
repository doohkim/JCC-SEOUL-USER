...
SOCIAL_AUTH_KAKAO_KEY = os.environ.get("KAKAO_REST_API_KEY") or secrets.KAKAO_REST_API_KEY
SOCIAL_AUTH_KAKAO_SECRET = os.environ.get("KAKAO_CLIENT_SECRET") or secrets.KAKAO_CLIENT_SECRET
