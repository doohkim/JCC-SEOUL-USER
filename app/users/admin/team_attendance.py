...
from users.choices import AttendanceChip
from users.models import Member, TeamMemberSlotAttendance, TeamAttendanceSession
...
class TeamAttendanceSessionAdmin(AuditLoggingModelAdminMixin, JccModelAdmin):
    change_form_template = "admin/users/team_session_change_form.html"
    ...
    def _slot_board_view(self, request, object_id):
        ...
        if request.method == "POST":
            ...
            return redirect("admin:users_teamattendancesession_slot_board", object_id=pk)
        ...
        return render(request, "admin/users/team_session_slot_board.html", context)
